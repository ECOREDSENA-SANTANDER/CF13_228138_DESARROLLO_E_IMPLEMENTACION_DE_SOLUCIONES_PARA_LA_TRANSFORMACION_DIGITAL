    ...
    .row.mb-5
      .col-md-8.mb-5.mb-md-0
        LineaTiempoD.color-secundario
          ...
          p.text-small(numero="2" titulo="Métricas") los valores surgen como resultado de una actividad específica y las medidas son el resultado de estas actividades en su conjunto o segmentación, siguiendo o no una serie de condiciones y operaciones. Por lo general las métricas se denominan KPI.
          
          p.text-small(numero="3" titulo="Listas") comúnmente formadas por KPI. En caso de que el cuadro de mando solo esté formado por este tipo de elemento, se denomina Scorecard.
          
          p.text-small(numero="4" titulo="Gráficos") el fin es mostrar datos con alto impacto visual, que sirva para obtener información acumulativa o calculada. Al igual que las tablas pueden tener múltiples dimensiones, pero se verán con mejor presentación y dimensión los datos. Se debe poner especial atención en el aspecto de la escalabilidad, pues hay datos que por su tamaño deben ser escalados para que se compare y se note las diferencias; sin embargo, ocasionalmente no es siempre recomendable, por ejemplo: un gráfico de barras si muestra la cantidad de dinero vendido, es factible escalar, para que el valor no empiece en 0 (cero), sino por ejemplo en 10 millones (según el tamaño de las cifras), pero si estas barras muestran porcentajes, es necesario que la gráfica siempre empiece desde el 0%, para que se note bien la dimensionalidad de los datos. <br> Este es el elemento más común y de mayor variabilidad, existen múltiples opciones de visualizadores gráficos en diferentes segmentos (barras, circulares, mayas, etc.).

          p.text-small(numero="5" titulo="Mapas") este elemento permite mostrar información geolocalizada. Aplica a los datos de ubicación, de esta manera se dimensiona la ubicación de las cifras que se estén representando

          p.text-small(numero="6" titulo="Alertas visuales") por lo general, al momento de desarrollar los cuadros de mando se pueden incluir a la programación de alertas automáticas con el fin de informar un acontecimiento crítico, ya sea por fechas u otro evento que suceda.

          p.text-small(numero="7" titulo="Menús de navegación") estos elementos visuales, ya sean en texto o botones, facilitan al usuario navegar y realizar operaciones interactivas en los elementos del cuadro de mando.
